...
THE GUI DONT SUPPORT MAC ONLY WINDOWS IF YOU USE JJSPLOIT OR ANYTHING WITH WRD API IT WONT WORK SO USE MAINDAB! DISCORD FOR FREE EXECUTOR MAINDAB: https://discord.gg/7eGGHdM OR BUY SYNAPSE.
